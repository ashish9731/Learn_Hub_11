          ...
          {filteredCompanies.length > 0 ? (
            ...
            <div className="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-700 dark:text-gray-400">No companies have been created yet.</p>
              </div>
            </div>
          )}
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg shadow-xl max-w-md w-full border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
              <div className="p-6">
                ...
                <p className="text-sm text-gray-700 mb-6 dark:text-gray-400">{logoUploadError}</p>
                <div className="flex justify-end space-x-3">
                  <button
