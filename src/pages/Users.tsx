          ...
          {filteredUsers.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
              {filteredUsers.map((user: any) => (
                <div key={user.id} className="bg-gray-100 rounded-lg border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow duration-200 dark:bg-gray-700 dark:border-gray-600">
                  <div className="p-5">
                    ...
                    <div className="mt-4 grid grid-cols-2 gap-2">
                      <div className="text-center p-2 bg-white rounded dark:bg-gray-800">
                        ...
                        <p className="text-sm font-medium text-black truncate dark:text-white">{getAdminName(user.company_id) || 'No Admin'}</p>
                      </div>
                      <div className="text-center p-2 bg-white rounded dark:bg-gray-800">
