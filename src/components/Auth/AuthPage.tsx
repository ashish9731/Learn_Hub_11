    ...
    <>
      ...
      {showPasswordChangeModal && (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
          <div className="bg-white/10 rounded-lg shadow-xl max-w-md w-full backdrop-blur-sm">
            <div className="p-6">
              <h3 className="text-lg font-medium text-white mb-4">Change Your Password</h3>
              ...
              <form onSubmit={handlePasswordChange} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="block w-full px-3 py-2 border border-white/20 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 bg-white/10 text-white backdrop-blur-sm"
